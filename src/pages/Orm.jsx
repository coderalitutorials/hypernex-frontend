...
//             <div>
//               <h2 className="text-3xl font-bold mb-4">Online Reputation Management</h2>
//               <p className="text-gray-400 leading-relaxed">
//                Protect and improve brand perception with proactive monitoring, response strategies, and transparent reporting.
//               </p>
//             </div>
...
//                 <span className="text-sm">Review monitoring & escalation</span>
//               </div>
//               <div className="flex items-center gap-3 bg-white/5 p-4 rounded-xl border border-white/10">
//                 <CheckCircle2 className="text-green-500 w-5 h-5" />
//                 <span className="text-sm">Response playbooks and timelines</span>
//               </div>
//               <div className="flex items-center gap-3 bg-white/5 p-4 rounded-xl border border-white/10">
//                 <CheckCircle2 className="text-green-500 w-5 h-5" />
//                 <span className="text-sm">Brand sentiment analysis</span>
//               </div>
//               <div className="flex items-center gap-3 bg-white/5 p-4 rounded-xl border border-white/10">
//                 <CheckCircle2 className="text-green-500 w-5 h-5" />
//                 <span className="text-sm">Monthly progress reporting</span>
//               </div>
//             </div>
//           </div>
