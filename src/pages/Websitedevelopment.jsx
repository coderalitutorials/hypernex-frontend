...
//             <div>
//               <h2 className="text-3xl font-bold mb-4">Website Development</h2>
//               <p className="text-gray-400 leading-relaxed">
//                Build a fast, reliable website that represents your brand and supports measurable business goals.
//               </p>
//             </div>
...
//                 <span className="text-sm">Responsive UI with modern frameworks</span>
//               </div>
//               <div className="flex items-center gap-3 bg-white/5 p-4 rounded-xl border border-white/10">
//                 <CheckCircle2 className="text-green-500 w-5 h-5" />
//                 <span className="text-sm">CMS or custom builds as needed</span>
//               </div>
//               <div className="flex items-center gap-3 bg-white/5 p-4 rounded-xl border border-white/10">
//                 <CheckCircle2 className="text-green-500 w-5 h-5" />
//                 <span className="text-sm">Performance & SEO best practices</span>
//               </div>
//               <div className="flex items-center gap-3 bg-white/5 p-4 rounded-xl border border-white/10">
//                 <CheckCircle2 className="text-green-500 w-5 h-5" />
//                 <span className="text-sm">Ongoing maintenance & support</span>
//               </div>
//             </div>
//           </div>
