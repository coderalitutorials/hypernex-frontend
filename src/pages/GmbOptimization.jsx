...
// // // Footer ka path aapke structure ke mutabiq (Siblings hain to ./footer)
// // import Footer from "./footer"; 

// // const GmbOptimization = () => {
// //   // GMB Specific Projects Data based on your uploaded images
// //   const gmbProjects = [
// //     {
// //       id: 1,
// //       title: 'Local Bakery Ranking',
// //       desc: 'Moved from rank #12 to top 3 in 30 days',
// //       img: 'https://images.unsplash.com/photo-1555507036-ab1f4038808a?q=80&w=1926&auto=format&fit=crop',
// //     },
// //     {
// //       id: 2,
// //       title: 'Spa Center Visibility Boost',
// //       desc: '4.8★ rating management campaign',
// //       img: 'https://images.unsplash.com/photo-1544161515-4af6b1d462c2?q=80&w=2070&auto=format&fit=crop',
// //     },
// //     {
// //       id: 3,
// //       title: 'Retail Chain Local SEO',
// //       desc: 'Multi-location citations & local schema',
// //       img: 'https://images.unsplash.com/photo-1441986300917-64674bd600d8?q=80&w=2070&auto=format&fit=crop',
// //     },
// //     {
// //       id: 4,
// //       title: 'Service Center Map Optimization',
// //       desc: 'Improved map pack visibility for service-based clients',
...
// //           <h1 className="text-4xl md:text-5xl font-black mb-4 uppercase tracking-tight">Our Services Portfolio</h1>
...
// //         {/* Info Box (Based on your Image) */}
// //         <div className="bg-[#11112b] rounded-3xl p-8 md:p-12 border border-white/5 shadow-2xl">
// //           <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
// //             <div>
// //               <h2 className="text-3xl font-bold mb-4">Google My Business Optimization</h2>
// //               <p className="text-gray-400 leading-relaxed">
// //                 Stand out locally with a well-optimized Google Business profile that attracts real nearby customers and builds trust.
// //               </p>
// //             </div>
            
// //             {/* Right side Bullet Points from Image */}
// //             <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
// //               <div className="flex items-center gap-3 bg-white/5 p-4 rounded-xl border border-white/10">
// //                 <CheckCircle2 className="text-green-500 w-5 h-5 shrink-0" />
// //                 <span className="text-sm">Complete profile setup & optimization</span>
// //               </div>
// //               <div className="flex items-center gap-3 bg-white/5 p-4 rounded-xl border border-white/10">
// //                 <CheckCircle2 className="text-green-500 w-5 h-5 shrink-0" />
// //                 <span className="text-sm">Local SEO: categories, citations, NAP consistency</span>
// //               </div>
// //               <div className="flex items-center gap-3 bg-white/5 p-4 rounded-xl border border-white/10">
// //                 <CheckCircle2 className="text-green-500 w-5 h-5 shrink-0" />
// //                 <span className="text-sm">Review generation & response strategy</span>
// //               </div>
// //               <div className="flex items-center gap-3 bg-white/5 p-4 rounded-xl border border-white/10">
// //                 <CheckCircle2 className="text-green-500 w-5 h-5 shrink-0" />
// //                 <span className="text-sm">Weekly performance insights</span>
// //               </div>
// //             </div>
// //           </div>
...
// //             {gmbProjects.map((project) => (
// //               <motion.div
// //                 key={project.id}
// //                 initial={{ opacity: 0, y: 20 }}
// //                 whileInView={{ opacity: 1, y: 0 }}
// //                 viewport={{ once: true }}
// //                 className="group bg-[#0a0a1a] rounded-2xl overflow-hidden border border-white/10 hover:border-blue-500/50 transition-all shadow-lg"
// //               >
...
//   // Is tab ko default rakha hai "Social Media Marketing" par
//   const [activeTab, setActiveTab] = useState('Social Media Marketing');

//   // Categories aur unke exact Paths (Jo aapne App.jsx mein rakhe hain)
//   const categories = [
//     { name: 'Social Media Marketing', path: '/portfolio' },
//     { name: 'GMB Optimization', path: '/gmb-optimization' },
//     { name: 'SEO', path: '/seo' },
//     { name: 'Graphic Designing', path: '/graphicdesigning' },
//     { name: 'Website Development', path: '/websitedevelopment' },
//     { name: 'ORM', path: '/orm' }
//   ];
...
//     // Agar Social Media ke ilawa koi aur click ho to navigate kare
//     if (cat.path !== '/portfolio') {
//       navigate(cat.path); 
//     }
//   };
...
//           <h1 className="text-4xl md:text-5xl font-black mb-4">Our Services Portfolio</h1>
//           <p className="text-[#3b82f6] font-bold tracking-[0.2em] uppercase text-sm">Portfolio</p>
//           <div className="w-24 h-1 bg-gradient-to-r from-[#00c2ff] to-[#9333ea] mx-auto mt-4"></div>
//         </div>
...
//             <button
//               key={cat.name}
//               onClick={() => handleNavigation(cat)} // Yahan navigation trigger ho rahi hai
//               className={`px-6 py-3 rounded-full font-bold text-sm transition-all duration-500 border ${
//                 activeTab === cat.name 
//                 ? 'bg-gradient-to-r from-[#00c2ff] to-[#9333ea] border-transparent shadow-[0_0_20px_rgba(59,130,246,0.5)] scale-105' 
//                 : 'bg-transparent border-gray-700 text-gray-400 hover:border-blue-500'
//               }`}
//             >
//               {cat.name}
...
//               <p className="text-gray-400 leading-relaxed">
//                 Expert solutions tailored to elevate your business. We focus on results that matter.
//               </p>
//             </div>
...
//           <h3 className="text-xl font-bold mb-8 border-l-4 border-blue-500 pl-4">Showcase Projects</h3>
//           <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
//             <AnimatePresence mode='wait'>
//               {projects.map((project) => (
//                 <motion.div
...
//           <h2 className="text-4xl md:text-6xl font-black mb-6 text-white leading-tight">Ready To Scale?</h2>
//           <motion.button
//             onClick={() => navigate('/contact')}
//             whileHover={{ scale: 1.1, boxShadow: "0px 0px 30px 5px rgba(59, 130, 246, 0.6)" }}
//             className="px-12 py-5 rounded-full font-bold text-xl border-2 border-blue-500 text-white uppercase tracking-wider bg-transparent hover:bg-blue-600 transition-all"
//           >
//             Contact Now
//           </motion.button>
//         </div>
