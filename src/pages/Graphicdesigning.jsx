...
//             <div>
//               <h2 className="text-3xl font-bold mb-4">Graphic Designing</h2>
//               <p className="text-gray-400 leading-relaxed">
//                 Clean, modern visuals that tell your brand story effectively across print and digital touchpoints.
//               </p>
//             </div>
...
//                 <span className="text-sm">Logos, branding, and identity systems</span>
//               </div>
//               <div className="flex items-center gap-3 bg-white/5 p-4 rounded-xl border border-white/10">
//                 <CheckCircle2 className="text-green-500 w-5 h-5" />
//                 <span className="text-sm">Social media posts, banners, and ads</span>
//               </div>
//               <div className="flex items-center gap-3 bg-white/5 p-4 rounded-xl border border-white/10">
//                 <CheckCircle2 className="text-green-500 w-5 h-5" />
//                 <span className="text-sm">Marketing collateral (flyers, brochures)</span>
//               </div>
//               <div className="flex items-center gap-3 bg-white/5 p-4 rounded-xl border border-white/10">
//                 <CheckCircle2 className="text-green-500 w-5 h-5" />
//                 <span className="text-sm">Fast delivery with revisions</span>
//               </div>
//             </div>
//           </div>
